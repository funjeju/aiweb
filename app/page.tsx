    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 pb-20 max-w-lg mx-auto text-center">
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-8">
          ...
          <Link
            href="/create"
            className="inline-flex items-center gap-2 bg-white text-indigo-600 font-bold px-8 py-4 rounded-2xl hover:bg-gray-50 transition-colors"
          >
            <Sparkles size={18} />
            무료로 만들기
          </Link>
